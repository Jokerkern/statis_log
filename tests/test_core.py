...
class TestStatisLog:
    ...
    def test_config(self):
        ...
        return {
            "collectors": {
                "test_collector": {"type": "mock_collector", "enabled": True}
            },
            "analyzers": {"test_analyzer": {"type": "mock_analyzer", "enabled": True}},
            "notifiers": {"test_notifier": {"type": "mock_notifier", "enabled": True}},
        }
