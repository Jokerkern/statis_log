...
from statis_log.utils.config import load_config, merge_configs, save_config
...
class TestConfig:
    ...
    def test_save_yaml_config(self):
        ...
        config = {
            "collectors": {
                "file_collector": {"type": "file", "path": "/var/log/app.log"}
            }
        }
    ...
    def test_merge_configs(self):
        ...
        base_config = {
            ...
            "analyzers": {"error_analyzer": {"type": "pattern"}},
        }

        # 覆盖配置
        override_config = {
            "collectors": {
                "file_collector": {"path": "/var/log/new.log"},
                "syslog_collector": {"type": "syslog"},
            },
            "notifiers": {"email": {"type": "email"}},
        }
