...
from statis_log.core import StatisLog, collector_registry, analyzer_registry, notifier_registry
...
def create_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--log-level", help="日志级别", choices=["DEBUG", "INFO", "WARNING", "ERROR"], default="INFO")
    ...
    init_parser.add_argument("--format", help="配置文件格式", choices=["json", "yaml"], default="yaml")
    
    # list 命令
    list_parser = subparsers.add_parser("list", help="列出可用的插件")
    list_parser.add_argument("--type", help="插件类型", choices=["collector", "analyzer", "notifier", "all"], default="all")
...
def handle_validate(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        # 验证基本结构
        required_sections = ["collectors", "analyzers", "notifiers", "notification_rules"]
