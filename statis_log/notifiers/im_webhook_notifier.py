...
class IMWebhookNotifier(BaseNotifier):
    ...
    def __init__(self, name: str, config: Optional[Dict[str, Any]] = None):
        ...
        self.url = self.config.get('url', 'https://im-api.4399om.com/message/sendByWebhook')
            ...
            for attempt in range(self.retry_count):
                try:
                    ...
                    if success:
                        ...
                        logger.warning(f"4399IM消息发送失败: 错误码={error_code}, 错误信息={error_msg}")
    ...
    def send_text_message(self, receiver_id: str, message: str, receiver_type: str = 'user') -> bool:
        """
        发送文本消息
    ...
    def send_markdown_message(self, receiver_id: str, content: str, receiver_type: str = 'user') -> bool:
        """
        发送Markdown消息
    ...
    def send_picture_message(self, receiver_id: str, url: str, title: str = "", description: str = "", receiver_type: str = 'user') -> bool:
        """
        发送图片消息
